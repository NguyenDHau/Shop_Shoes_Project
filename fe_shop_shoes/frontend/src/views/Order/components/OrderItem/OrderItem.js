...
//   return (
//     <Box sx={{ display: 'flex', p: 2, alignItems: 'center', justifyContent: 'space-between', my: 1, flexWrap: 'wrap' }}>
//       <Box display="flex" alignItems="center" overflow="hidden">
//         <Box component="img" sx={{ height: 90, width: 90, borderRadius: 4, mr: 2 }} src={product.product.thumbnail} alt={product.product?.title} />
